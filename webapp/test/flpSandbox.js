		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Seguimiento Inventario Cultivo",
									"targetURL": "#aipasinvcultivo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aipasinvcultivo-display": {
								"semanticObject": "aipasinvcultivo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aip.as.invcultivo",
									"url": sap.ui.require.toUrl("aip/as/invcultivo")
								}
							}
						}
					}
